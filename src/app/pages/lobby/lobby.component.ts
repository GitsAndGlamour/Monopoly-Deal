...
import {NotificationProfileService} from '../../services/profile/notification-profile.service';
...
export class LobbyComponent implements OnInit {
  ...
  constructor(private auth: AuthService,
              private profileService: NotificationProfileService,
  ...
  async clearNotifications() {
    await this.profileService.clearNotifications();
  }
}
